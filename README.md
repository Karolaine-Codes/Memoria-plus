...
O sistema de pontuação recompensa o jogador pela identificação correta dos pares.

A pontuação também considera o **combo**, incentivando uma sequência de acertos.
